...
public class DemonWebApplicationConfig  extends WebMvcConfigurerAdapter implements EmbeddedServletContainerCustomizer{
    ...
    public FilterRegistrationBean appFilter() {
        ...
        reg.setFilter(new DemonWebApplicationFilter());
        reg.addUrlPatterns("/*");
        return reg;
    }

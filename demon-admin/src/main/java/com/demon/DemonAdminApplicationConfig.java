...
import com.demon.access.AdminArgumentResolver;
import com.demon.access.AdminAuthorityHandlerInterceptor;
...
public class DemonAdminApplicationConfig  extends WebMvcConfigurerAdapter implements EmbeddedServletContainerCustomizer{
    ...
    public FilterRegistrationBean appFilter() {
        ...
        reg.setFilter(new DemonAdminApplicationFilter());
        reg.addUrlPatterns("/*");
        return reg;
    }

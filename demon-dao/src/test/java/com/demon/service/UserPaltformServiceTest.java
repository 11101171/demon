...
import com.demon.DemonDaoApplication;
import com.demon.domain.UserPlatform;
import com.demon.service.UserPlatformService;

@RunWith(SpringJUnit4ClassRunner.class)
@SpringApplicationConfiguration(DemonDaoApplication.class)
public class UserPaltformServiceTest {
	...
	public void cache() throws InterruptedException{
		...
		this.userPlatformService.update(record.getId(), record.getLoginUsername(), "aaaaaaaa");
		Thread.sleep(5);
	...
	public void save() {
		UserPlatform record =  new UserPlatform();
		record.setLoginPassword("password");
		record.setLoginUsername("username");
		this.userPlatformService.save(record);
	}
	...
	public void update() {
		...
		int rows = userPlatformService.update(id, loginUsername, loginPassword);
